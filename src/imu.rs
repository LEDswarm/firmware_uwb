...
use ledswarm_protocol::{InternalMessage, Message, Notice};
use esp_idf_svc::hal::gpio::{Gpio21, Gpio22};
use esp_idf_svc::hal::prelude::*;

use crate::moving_average;

pub fn start(tx: Sender<InternalMessage>, i2c: I2C0, sda: Gpio21, scl: Gpio22) -> Result<(), EspError> {
    std::thread::spawn(move || {
        ...
        loop {
            ...
            tx.send(InternalMessage::AccelerometerDelta(delta)).unwrap();
